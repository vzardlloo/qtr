...
export function TranslatorApp({ engineName, defaultFrom, defaultTo, isEngineConfigured, onEngineChange, onPersistEngine, onRequestSetup, }) {
    ...
    return (_jsxs(Box, { flexDirection: "column", padding: 1, gap: 1, children: [_jsx(QtrBanner, {}), _jsxs(Box, { justifyContent: "space-between", children: [_jsxs(Text, { children: [_jsx(Text, { color: "cyanBright", children: "qtr" }), ' ', _jsx(Text, { dimColor: true, children: "Ink \u00B7 React \u00B7 Node" })] }), _jsx(StatusBadge, { status: status })] }), _jsx(Box, { borderStyle: "round", borderColor: "cyan", paddingX: 1, paddingY: 0, children: _jsxs(Box, { flexDirection: "column", width: "100%", children: [_jsxs(Box, { justifyContent: "space-between", children: [_jsxs(Text, { children: ["Engine: ", _jsx(Text, { color: "yellow", children: engineName }), ' ', _jsx(Text, { dimColor: true, children: "(Tab to choose)" })] }), _jsxs(Text, { children: ["from ", _jsx(Text, { color: "green", children: from }), " \u00B7 to", ' ', _jsx(Text, { color: "green", children: to })] })] }), isEnginePanelOpen ? (_jsx(Box, { marginTop: 1, children: _jsx(EngineSelectPanel, { engines: engines, highlightedIndex: engineHighlightedIndex, selectedEngine: engineName }) })) : null, languagePanel ? (_jsx(Box, { marginTop: 1, children: _jsx(LanguageSelectPanel, { title: languagePanel === 'from'
                                    ? 'Choose source language'
                                    : 'Choose target language', items: LANGUAGES, highlightedIndex: languageHighlightedIndex, selectedCode: languagePanel === 'from' ? from : to }) })) : null, _jsx(Box, { marginTop: 1, children: _jsx(TextInput, { value: input, onChange: setInput, placeholder: "Type to translate\u2026", isDisabled: isInputDisabled }) })] }) }), _jsx(ResultBox, { engineName: engineName, status: status, result: result, errorMessage: errorMessage }), _jsx(Text, { dimColor: true, children: "Keys: Tab engine \u00B7 Ctrl+F choose from \u00B7 Ctrl+T choose to \u00B7 Ctrl+S save engine \u00B7 Ctrl+L clear \u00B7 Esc/Ctrl+C exit" })] }));
}
